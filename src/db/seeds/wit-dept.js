exports.seed = function (knex) {
  ...
  return knex('departments').then(function () {
    ...
    return knex('departments').insert([
      // {"FACULTY OF COMMERCE, LAW AND MANAGEMENT": "0"},
      {
      ...
      // {"SCHOOL OF HUMAN AND COMMUNITY DEVELOPMENT": "0"},
      {
      ...
      // {"SCHOOL OF LITERATURE, LANGUAGE AND MEDIA": "0"},
      {
