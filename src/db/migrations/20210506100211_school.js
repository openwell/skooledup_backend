exports.up = function (knex) {
  return knex.schema
    ...
    .createTable('courses', (tbl) => {
      ...
      tbl.string('international_fee_local', 255);
      tbl.string('levy', 255);
      ...
      tbl.string('international_min_req_local_aps', 255);
      tbl.string('international_min_req_local_english', 255);
      tbl.string('international_min_req_local_additional_lang', 255);
      tbl.string('international_min_req_local_mathematics', 255);
